package com.devpaul.swiftmvc.framework
{
	...
	public class SwiftFacadeTest
	{
		...
		{
			var facade:SwiftFacade = MockFactory.createMockFacade(FACADE_KEY);
			MockFactory.prepInjector(SwiftInjector(facade.injector));
		}
		
		[AfterClass]
		public static function teardown():void
		{
			Facade.removeCore(FACADE_KEY);
		}
		...
		{
			var facade:SwiftFacade = SwiftFacade.getInstance(FACADE_KEY);
