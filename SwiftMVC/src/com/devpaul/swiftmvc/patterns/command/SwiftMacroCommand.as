package com.devpaul.swiftmvc.patterns.command
{
	 ...
	 */
	public class SwiftMacroCommand extends Notifier implements ICommand, INotifier
	{
		 ...
		 */
		public function SwiftMacroCommand()
		{
		...
		{
			return SwiftFacade(this.facade).injector;
		}
